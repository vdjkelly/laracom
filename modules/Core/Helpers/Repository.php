...
use Modules\Core\Providers\Modules;
use Modules\Core\Providers\ModuleServiceProvider;
use Modules\Core\Contracts\RepositoryContract;

class Repository implements RepositoryContract, Countable
{
    use Macroable;
    ...
    public function scan()
    {
        ...
        foreach ($paths as $key => $path) {
            ...
            foreach ($manifests as $manifest) {
                ...
                $modules[$name] = new Modules($this->app, $name, dirname($manifest));
            }
        }
    ...
    protected function formatCached($cached)
    {
        ...
        foreach ($cached as $name => $module) {
            ...
            $modules[$name] = new ModuleServiceProvider($this->app, $name, $path);
        }
    ...
    public function getOrdered($direction = 'asc')
    {
        ...
        uasort($modules, function (Modules $a, Modules $b) use ($direction) {
            if ($a->order == $b->order) {
                return 0;
            }
